...
public class RabbitMqConfig {
    ...
    @Bean
    public Binding orderEventsBinding(Queue orderEventsQueue, TopicExchange sagaExchange) {
        return BindingBuilder.bind(orderEventsQueue).to(sagaExchange).with("order.events");
    }
